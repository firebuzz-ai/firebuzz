      ...
      <div className="container px-4 mx-auto">
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            {/* Benefits Grid */}
            <div className="grid grid-cols-2 gap-4 mx-auto mb-8 max-w-md">
            ...
            >
              ...
              <div className="flex flex-wrap gap-6 justify-center items-center text-sm text-primary-foreground/70">
