		...
		<main className="container mx-auto px-4 py-12 max-w-6xl">
			...
			<div className="text-center mb-12">
				...
				<div className="relative max-w-2xl mx-auto mb-6">
					...
					>
						<svg
							className="absolute left-4 top-1/2 transform -translate-y-1/2 text-fd-muted-foreground w-5 h-5"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
						>
				...
				<div className="flex flex-wrap justify-center gap-3">
					...
					<button
						type="button"
						className="px-3 py-1 text-sm bg-fd-muted text-fd-muted-foreground rounded-md hover:bg-fd-accent transition-colors"
					>
						importing
					</button>
					<button
				...
				>
					<div className="flex flex-col items-center text-center">
						<div className="w-16 h-16 mb-4 flex items-center justify-center">
							<svg
								className="w-8 h-8 text-fd-primary"
								fill="none"
								stroke="currentColor"
								viewBox="0 0 24 24"
							>
