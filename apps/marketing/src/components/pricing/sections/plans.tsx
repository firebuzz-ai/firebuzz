      ...
      <div className="pt-24 border-x">
        <div className="grid overflow-hidden grid-cols-12">
          ...
          <div className="grid grid-cols-12 col-span-full gap-0">
            ...
            <div className="col-span-full border-t md:col-span-4 bg-muted md:border-x">
          ...
          {plans.map((plan) => (
            <div
              ...
              className={`overflow-hidden col-span-full row-span-2 sm:col-span-4 ${
                plan.highlighted ? "sm:border bg-muted" : "border-t border-b"
              }`}
            >
          ...
          {/* Enterprise */}
          <div className="grid relative grid-cols-1 col-span-full gap-8 px-8 py-12 border-b lg:gap-0 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="relative z-10 col-span-1 lg:col-span-2">
            ...
            {/* Features */}
            <div className="grid relative z-10 grid-cols-1 col-span-1 space-y-2 text-sm sm:grid-cols-2 lg:px-8 lg:grid-cols-1 text-muted-foreground">
