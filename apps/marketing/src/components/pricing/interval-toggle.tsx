		...
		>
			...
			>
				...
				<button
					...
					className={`relative z-10 px-3 py-2 flex-1 group rounded-2xl text-nowrap text-sm font-medium transition-all duration-100 ease-out flex items-cente justify-center gap-2 ${
						isYearly
							? "text-primary-foreground"
							: "opacity-50 hover:opacity-100"
					}`}
