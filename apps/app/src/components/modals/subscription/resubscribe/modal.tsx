                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Get immediate access to all your previous features and data
                    </p>
                  </div>
                </div>
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium">Everything Preserved</h4>
                    <p className="text-xs text-muted-foreground">
                      All your projects, settings, and data remain exactly as you left them
                    </p>
                  </div>
                </div>
                <div className="flex gap-3 items-start">
              ...
              <div className="space-y-2">
                ...
                <div className="pt-2 border-t">
                  <p className="text-xs text-muted-foreground">
                    ...
                    charged {formattedPrice} immediately using your saved payment method.
                  </p>
                </div>
              </div>
            </div>
