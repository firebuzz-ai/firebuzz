					...
					<div className="flex h-[200px] items-center justify-center">
						<div className="text-center">
							<p className="text-sm text-muted-foreground">
								No landing page conversion data available
							</p>
						</div>
					</div>
				</CardContent>
						...
						>
							<div className="flex flex-1 items-center min-w-0">
								<div className="flex gap-2 items-center">
									<div
										className={cn(
											"px-1.5 py-0.5 text-xs font-medium tabular-nums rounded-md border bg-muted",
										)}
									>
										{index === 0 ? (
								...
								<div className="flex flex-1 justify-center items-stretch text-xs text-muted-foreground">
									<div className="flex items-center px-2 py-2 h-full border-l bg-background-subtle text-primary">
										{landingPage.conversions} conversions
									</div>
									<div className="flex items-center px-2 py-2 h-full border-l">
									...
									{landingPage.conversionValue > 0 && (
										<div className="flex items-center px-2 py-2 h-full border-r border-l">
				...
				<div className="flex justify-between items-center px-6 py-4 text-sm border-t">
					<div className="flex-col gap-2 items-start">
						...
						<div className="leading-none text-muted-foreground">
							...
							{((topLandingPage.conversions / totalConversions) * 100).toFixed(
								1,
							)}
							%)
						</div>
