...
interface GetFeaturesOrServicesProps {
	part: UIToolInvocation<ToolSet["getFeaturesOrServices"]>;
}

export const GetFeaturesOrServices = ({ part }: GetFeaturesOrServicesProps) => {
	...
	const message = useMemo(() => {
		...
		if (part.input) {
			...
			return <span className="text-xs">Fetching {numItems} features...</span>;
		}
	...
	return (
		<ToolPart className="justify-start" status={status} toolName="Get Features">
			{message}
		</ToolPart>
	);
};
