...
export const RADIUS_OPTIONS = [
	...
	},
	{
		value: "2rem",
		label: "XLarge",
		description: "High roundness (2rem)",
	},
];
...
export const LAST_THEMES = [
	{
		id: "modern-minimal",
		name: "Modern Minimal",
		description: "Modern Minimal theme with custom styling",
		colors: ["#3b82f6", "#ffffff", "#f3f4f6", "#e0f2fe"],
		lightTheme: {
			background: "#ffffff",
			foreground: "#333333",
			card: "#ffffff",
	...
	},
	{
		id: "t3-chat",
		name: "T3 Chat",
		description: "T3 Chat theme with custom styling",
		colors: ["#a84370", "#ffffff", "#f1c4e6", "#f1c4e6"],
		lightTheme: {
			background: "#faf5fa",
			foreground: "#501854",
			card: "#faf5fa",
	...
	},
	{
		id: "twitter",
		name: "Twitter",
		description: "Twitter theme with custom styling",
		colors: ["#1e9df1", "#ffffff", "#0f1419", "#E3ECF6"],
		lightTheme: {
			background: "#ffffff",
			foreground: "#0f1419",
			card: "#f7f8f8",
	...
	},
	{
		id: "mocha-mousse",
		name: "Mocha Mousse",
		description: "Mocha Mousse theme with custom styling",
		colors: ["#A37764", "#FFFFFF", "#BAAB92", "#E4C7B8"],
		lightTheme: {
			background: "#F1F0E5",
			foreground: "#56453F",
			card: "#F1F0E5",
	...
	},
	{
		id: "notebook",
		name: "Notebook",
		description: "Notebook theme with custom styling",
		colors: ["#606060", "#f0f0f0", "#dedede", "#f3eac8"],
		lightTheme: {
			background: "#f9f9f9",
			foreground: "#3a3a3a",
			card: "#ffffff",
	...
	},
	{
		id: "doom-64",
		name: "Doom 64",
		description: "Doom 64 theme with custom styling",
		colors: ["#b71c1c", "#ffffff", "#556b2f", "#4682b4"],
		lightTheme: {
			background: "#cccccc",
			foreground: "#1f1f1f",
			card: "#b0b0b0",
	...
	},
	{
		id: "catppuccin",
		name: "Catppuccin",
		description: "Catppuccin theme with custom styling",
		colors: ["#8839ef", "#ffffff", "#ccd0da", "#04a5e5"],
		lightTheme: {
			background: "#eff1f5",
			foreground: "#4c4f69",
			card: "#ffffff",
	...
	},
	{
		id: "graphite",
		name: "Graphite",
		description: "Graphite theme with custom styling",
		colors: ["#606060", "#ffffff", "#e0e0e0", "#c0c0c0"],
		lightTheme: {
			background: "#f0f0f0",
			foreground: "#333333",
			card: "#f5f5f5",
	...
	},
	{
		id: "perpetuity",
		name: "Perpetuity",
		description: "Perpetuity theme with custom styling",
		colors: ["#06858e", "#ffffff", "#d9eaea", "#c9e5e7"],
		lightTheme: {
			background: "#e8f0f0",
			foreground: "#0a4a55",
			card: "#f2f7f7",
	...
	},
	{
		id: "kodama-grove",
		name: "Kodama Grove",
		description: "Kodama Grove theme with custom styling",
		colors: ["#8d9d4f", "#fdfbf6", "#decea0", "#dbc894"],
		lightTheme: {
			background: "#e4d7b0",
			foreground: "#5c4b3e",
			card: "#e7dbbf",
	...
	},
	{
		id: "cosmic-night",
		name: "Cosmic Night",
		description: "Cosmic Night theme with custom styling",
		colors: ["#6e56cf", "#ffffff", "#e4dfff", "#d8e6ff"],
		lightTheme: {
			background: "#f5f5ff",
			foreground: "#2a2a4a",
			card: "#ffffff",
	...
	},
	{
		id: "tangerine",
		name: "Tangerine",
		description: "Tangerine theme with custom styling",
		colors: ["#e05d38", "#ffffff", "#f3f4f6", "#d6e4f0"],
		lightTheme: {
			background: "#e8ebed",
			foreground: "#333333",
			card: "#ffffff",
	...
	},
	{
		id: "quantum-rose",
		name: "Quantum Rose",
		description: "Quantum Rose theme with custom styling",
		colors: ["#e6067a", "#ffffff", "#ffd6ff", "#ffc1e3"],
		lightTheme: {
			background: "#fff0f8",
			foreground: "#91185c",
			card: "#fff7fc",
	...
	},
	{
		id: "nature",
		name: "Nature",
		description: "Nature theme with custom styling",
		colors: ["#2e7d32", "#ffffff", "#e8f5e9", "#c8e6c9"],
		lightTheme: {
			background: "#f8f5f0",
			foreground: "#3e2723",
			card: "#f8f5f0",
	...
	},
	{
		id: "elegant-luxury",
		name: "Elegant Luxury",
		description: "Elegant Luxury theme with custom styling",
		colors: ["#9b2c2c", "#ffffff", "#fdf2d6", "#fef3c7"],
		lightTheme: {
			background: "#faf7f5",
			foreground: "#1a1a1a",
			card: "#faf7f5",
	...
	},
	{
		id: "supabase",
		name: "Supabase",
		description: "Supabase theme with custom styling",
		colors: ["#72e3ad", "#1e2723", "#fdfdfd", "#ededed"],
		lightTheme: {
			background: "#fcfcfc",
			foreground: "#171717",
			card: "#fcfcfc",
	...
	},
	{
		id: "neo-brutalism",
		name: "Neo Brutalism",
		description: "Neo Brutalism theme with custom styling",
		colors: ["#ff3333", "#ffffff", "#ffff00", "#0066ff"],
		lightTheme: {
			background: "#ffffff",
			foreground: "#000000",
			card: "#ffffff",
	...
	},
	{
		id: "solar-dusk",
		name: "Solar Dusk",
		description: "Solar Dusk theme with custom styling",
		colors: ["#B45309", "#FFFFFF", "#E4C090", "#f2daba"],
		lightTheme: {
			background: "#FDFBF7",
			foreground: "#4A3B33",
			card: "#F8F4EE",
	...
	},
	{
		id: "claymorphism",
		name: "Claymorphism",
		description: "Claymorphism theme with custom styling",
		colors: ["#6366f1", "#ffffff", "#d6d3d1", "#f3e5f5"],
		lightTheme: {
			background: "#e7e5e4",
			foreground: "#1e293b",
			card: "#f5f5f4",
	...
	},
	{
		id: "cyberpunk",
		name: "Cyberpunk",
		description: "Cyberpunk theme with custom styling",
		colors: ["#ff00c8", "#ffffff", "#f0f0ff", "#00ffcc"],
		lightTheme: {
			background: "#f8f9fa",
			foreground: "#0c0c1d",
			card: "#ffffff",
	...
	},
	{
		id: "pastel-dreams",
		name: "Pastel Dreams",
		description: "Pastel Dreams theme with custom styling",
		colors: ["#a78bfa", "#ffffff", "#e9d8fd", "#f3e5f5"],
		lightTheme: {
			background: "#f7f3f9",
			foreground: "#374151",
			card: "#ffffff",
	...
	},
	{
		id: "clean-slate",
		name: "Clean Slate",
		description: "Clean Slate theme with custom styling",
		colors: ["#6366f1", "#ffffff", "#e5e7eb", "#e0e7ff"],
		lightTheme: {
			background: "#f8fafc",
			foreground: "#1e293b",
			card: "#ffffff",
	...
	},
	{
		id: "retro-arcade",
		name: "Retro Arcade",
		description: "Retro Arcade theme with custom styling",
		colors: ["#d33682", "#ffffff", "#2aa198", "#cb4b16"],
		lightTheme: {
			background: "#fdf6e3",
			foreground: "#073642",
			card: "#eee8d5",
	...
	},
	{
		id: "midnight-bloom",
		name: "Midnight Bloom",
		description: "Midnight Bloom theme with custom styling",
		colors: ["#6c5ce7", "#ffffff", "#a1c9f2", "#8b9467"],
		lightTheme: {
			background: "#f9f9f9",
			foreground: "#333333",
			card: "#ffffff",
	...
	},
	{
		...
		description: "Northern Lights theme with custom styling",
		colors: ["#34a85a", "#ffffff", "#6495ed", "#66d9ef"],
		lightTheme: {
			background: "#f9f9fa",
			foreground: "#333333",
			card: "#ffffff",
	...
	},
	{
		id: "vintage-paper",
		name: "Vintage Paper",
		description: "Vintage Paper theme with custom styling",
		colors: ["#a67c52", "#ffffff", "#e2d8c3", "#d4c8aa"],
		lightTheme: {
			background: "#f5f1e6",
			foreground: "#4a3f35",
			card: "#fffcf5",
	...
	},
	{
		id: "sunset-horizon",
		name: "Sunset Horizon",
		description: "Sunset Horizon theme with custom styling",
		colors: ["#ff7e5f", "#ffffff", "#ffedea", "#feb47b"],
		lightTheme: {
			background: "#fff9f5",
			foreground: "#3d3436",
			card: "#ffffff",
	...
	},
	{
		id: "starry-night",
		name: "Starry Night",
		description: "Starry Night theme with custom styling",
		colors: ["#3a5ba0", "#fffbe6", "#f7c873", "#6ea3c1"],
		lightTheme: {
			background: "#f5f7fa",
			foreground: "#1a2238",
			card: "#e3eaf2",
	...
	},
	{
		id: "claude",
		name: "Claude",
		description: "Claude theme with custom styling",
		colors: ["#c96442", "#ffffff", "#e9e6dc", "#e9e6dc"],
		lightTheme: {
			background: "#faf9f5",
			foreground: "#3d3929",
			card: "#faf9f5",
...

	{
		id: "mono",
		name: "Mono",
		description: "Mono theme with custom styling",
		colors: ["#737373", "#fafafa", "#f5f5f5", "#f5f5f5"],
		lightTheme: {
			background: "#ffffff",
			foreground: "#0a0a0a",
			card: "#ffffff",
