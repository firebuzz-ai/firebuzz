...
export const PreviewCards = ({
  ...
  const getBrandAvatar = () => {
    ...
    if (theme === "dark")
      return `${NEXT_PUBLIC_R2_PUBLIC_URL}/${brandIconDark ?? brandIconLight ?? formValues?.favicon}`;
    if (theme === "light")
      return `${NEXT_PUBLIC_R2_PUBLIC_URL}/${brandIconLight ?? brandIconDark ?? formValues?.favicon}`;
  };
          ...
          <CardContent className="p-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-1.5 text-sm">
                {formValues?.favicon ? (
                  <Image
                    src={`${NEXT_PUBLIC_R2_PUBLIC_URL}/${formValues?.favicon}`}
                    alt="Site favicon"
                    width={16}
                    height={16}
                ...
                <div className="overflow-hidden border border-border rounded-2xl bg-background">
                  {formValues?.twitterCard?.image && (
                    <div className="relative overflow-hidden aspect-video bg-muted">
                      <Image
                        src={`${NEXT_PUBLIC_R2_PUBLIC_URL}/${formValues?.twitterCard.image}`}
                        alt="Twitter Card"
                        fill
                        className="object-cover"
                        unoptimized
            ...
            <div className="space-y-3">
              ...
              <div className="overflow-hidden border rounded-lg border-border bg-background">
                {formValues?.opengraph?.image && (
                  <div className="relative overflow-hidden aspect-video bg-muted">
                    <Image
                      src={`${NEXT_PUBLIC_R2_PUBLIC_URL}/${formValues?.opengraph.image}`}
                      alt="OpenGraph"
                      fill
                      className="object-cover"
                      unoptimized
