...
interface TestimonialSearchBarProps {
  isVisible: boolean;
  setSearchResults: Dispatch<SetStateAction<Doc<"testimonials">[]>>;
  setIsSearchActive: Dispatch<SetStateAction<boolean>>;
  isSearchActive: boolean;
}

export const TestimonialSearchBar = ({
  isVisible,
  setSearchResults,
  setIsSearchActive,
  isSearchActive,
}: TestimonialSearchBarProps) => {
  ...
  const isSearchPending = searchStatus === "LoadingFirstPage";
