...
export const ThemeForm = ({
  ...
  const themes = useMemo((): Array<{
    ...
    const darkThemeEntries = Object.entries(formValues.darkTheme || {}).filter(
      ([key]) => key !== "radius"
    );
  ...
  const handleColorClick = (color: {
    ...
    // Switch to the theme being edited if it's not currently active
