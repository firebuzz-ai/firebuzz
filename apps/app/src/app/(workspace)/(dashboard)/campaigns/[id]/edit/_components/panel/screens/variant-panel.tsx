...
export const VariantPanel = ({ node, campaign }: VariantPanelProps) => {
	...
	// Get used landing page IDs by other variants (excluding current)
	...
	}, [allVariantNodes, node.id]);

	// Get variant letter for other variants using the same landing page
	const getVariantLetterForLandingPage = (landingPageId: string) => {
		const variantUsingPage = allVariantNodes.find(
			(variant) =>
					...
					<div className="space-y-3">
						...
						{!campaign ? (
							...
							<>
								...
								>
									<SelectTrigger id="landing-page" className="h-8">
								...
								<p className="text-xs text-muted-foreground">
									This page will be shown to traffic assigned to this variant
								</p>
							</>
						) : (
					...
					<div className="space-y-3">
						<div className="flex justify-between items-center">
							...
							<Tooltip>
								...
								<TooltipContent>
									<p>Edit traffic distribution in A/B Test panel</p>
								</TooltipContent>
							</Tooltip>
						</div>
