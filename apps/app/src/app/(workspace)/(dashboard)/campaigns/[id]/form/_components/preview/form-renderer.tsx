...
export const FormRenderer = () => {
	...
	// Get current form data from canvas node
	const { formFields, submitButtonText } = useMemo(() => {
		if (formNode) {
			const nodeData = formNode.data as unknown as FormNodeData;
			return {
				formFields: nodeData.schema || [],
				submitButtonText: nodeData.submitButtonText || "Submit",
				successMessage: nodeData.successMessage || "Thank you!",
			};
		}
		return {
			formFields: [],
