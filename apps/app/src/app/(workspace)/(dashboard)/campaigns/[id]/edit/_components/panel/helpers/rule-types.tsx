...
export const RULE_TYPE_DEFINITIONS: Record<RuleTypeId, RuleTypeDefinition> = {
	...
	isEUCountry: {
		...
		hideOperatorSelection: true,
		options: [
			{ value: "true", label: "Is from EU" },
			{ value: "false", label: "Not from EU" },
		],
		customInputAllowed: false,
	},
	language: {
	...
	utmCampaign: {
		id: "utmCampaign",
		label: "UTM Campaign",
		description: "Target by campaign name",
		icon: <Share2 className="w-4 h-4" />,
		valueType: "string",
		supportedOperators: [
			"equals",
	...
	utmTerm: {
		id: "utmTerm",
		label: "UTM Term",
		description: "Filter by search keywords",
		icon: <Search className="w-4 h-4" />,
		valueType: "string",
		supportedOperators: [
			"equals",
	...
	utmContent: {
		id: "utmContent",
		label: "UTM Content",
		description: "Target by content variation",
