/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 159fd76a42be36d0907b7c88fd01ff9b)
// Runtime types generated with workerd@1.20250917.0 2025-02-04 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ABTestDurableObject" | "EventTrackerDurableObject" | "AgentSessionDurableObject";
	}
	interface Env {
		ASSETS: KVNamespace;
		CACHE: KVNamespace;
		...
		TRACKING_JWT_SECRET: string;
		SANDBOX_LOGGER_URL: string;
		...
		AGENT_SESSION: DurableObjectNamespace<import("./src/index").AgentSessionDurableObject>;
