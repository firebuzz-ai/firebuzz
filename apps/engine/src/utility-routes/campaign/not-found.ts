	...
	<html lang="en">
		...
		<body>
			<main class="wrapper" role="main">
				...
				<h1>Campaign <span class="accent">Not Found</span></h1>
				<p class="lead">
					We couldn't find a campaign at this address. It may not be published yet, or you might have just made changes. Please wait up to 60 seconds for the cache to refresh and try again.
				</p>

				<div class="hint">Is this your campaign? <a class="text-link" href="https://app.getfirebuzz.com" target="_blank" rel="noopener noreferrer">Manage your campaign</a></div>
			</main>
			<div class="footer">
...
export { app as campaignNotFound };
