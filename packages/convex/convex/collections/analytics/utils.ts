...
export function generateStructuredKeyForAbTestResult(params: {
  campaignId: string;
  queryId: string;
  abTestId: string;
  ...
  return `${params.campaignId}_${params.queryId}_${params.abTestId}_${params.conversionEventId}_${params.confidenceLevel}_${params.campaignEnvironment}`;
}
