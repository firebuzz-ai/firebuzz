...
export const audienceBreakdownSchema = v.object({
	...
	payload: v.object({
		...
		// Format: [name, sessions, users, new_sessions, returning_sessions, percentage]
		...
		continents: v.array(v.array(v.union(v.string(), v.number()))),
		languages: v.array(v.array(v.union(v.string(), v.number()))),
		timezones: v.array(v.array(v.union(v.string(), v.number()))),
		...
		// Format: [user_type, sessions, users, percentage] (no new/returning breakdown)
...
export const conversionsBreakdownSchema = v.object({
	...
	payload: v.object({
		...
		referrer_conversions: v.array(v.array(v.union(v.string(), v.number()))),
		source_conversions: v.array(v.array(v.union(v.string(), v.number()))),
