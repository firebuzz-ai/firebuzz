...
export const update = internalMutationWithTrigger({
  args: {
    ...
    vectorizationStatus: v.optional(
      documentsSchema.validator.fields.vectorizationStatus
    ),
    chunkingStatus: v.optional(documentsSchema.validator.fields.chunkingStatus),
