...
export const audienceInsertSchema = v.object({
	name: audienceSchema.fields.name,
	description: audienceSchema.fields.description,
	gender: audienceSchema.fields.gender,
	age: audienceSchema.fields.age,
	goals: audienceSchema.fields.goals,
	motivations: audienceSchema.fields.motivations,
	frustrations: audienceSchema.fields.frustrations,
	terminologies: audienceSchema.fields.terminologies,
	avatar: audienceSchema.fields.avatar,
});
