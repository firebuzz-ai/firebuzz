...
export const update = internalMutation({
	args: {
		...
		step1: onboardingSchema.step1,
		step2: onboardingSchema.step2,
		step3: onboardingSchema.step3,
		step4: onboardingSchema.step4,
		step5: onboardingSchema.step5,
		internalWorkflowIds: onboardingSchema.internalWorkflowIds,
