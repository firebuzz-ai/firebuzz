	...
	args: {
		...
		messages: v.array(
			v.object({
				id: v.string(),
				groupId: v.string(),
				role: landingPageMessagesSchema.validator.fields.role,
				createdAt: v.string(),
				metadata: v.optional(
					v.object({
						isSystem: v.boolean(),
				...
				attachments: landingPageMessagesSchema.validator.fields.attachments,
				parts: landingPageMessagesSchema.validator.fields.parts,
			}),
		),
	},
