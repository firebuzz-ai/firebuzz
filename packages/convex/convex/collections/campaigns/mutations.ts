...
export const createCampaign = mutationWithTrigger({
  args: {
    title: v.string(),
...
export const deleteCampaignInternal = internalMutationWithTrigger({
  args: {
    id: v.id("campaigns"),
  },
...
export const archiveCampaign = mutationWithTrigger({
  args: {
    id: v.id("campaigns"),
  },
  handler: async (ctx, { id }) => {
...
export const restoreCampaign = mutationWithTrigger({
  args: {
    id: v.id("campaigns"),
  },
  handler: async (ctx, { id }) => {
...
export const deleteCampaign = mutationWithTrigger({
  args: {
    id: v.id("campaigns"),
  },
  handler: async (ctx, { id }) => {
...
export const publishCampaign = mutationWithTrigger({
  args: {
    id: v.id("campaigns"),
  },
  handler: async (ctx, { id }) => {
...
export const updateCampaign = mutationWithTrigger({
  args: {
    id: v.id("campaigns"),
    projectId: v.id("projects"),
