...
// Controls how language-based routing is handled for a segment
export const translationMode = v.union(
	v.literal("disabled"),
	v.literal("auto-detect"),
	v.literal("parameter"),
);
...
export const segmentNodeData = v.object({
	...
	// If not set, treat as "disabled" in the client for backwards compatibility
	translationMode,
...
export type TranslationMode = Infer<typeof translationMode>;
