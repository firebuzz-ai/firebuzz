...
const abTestResultParamsSchema = z.object({
  workspaceId: z.string(),
  projectId: z.string(),
  campaignId: z.string(),
  environment: z.union([
  ...
  abTestId: z.string(),
  conversionEventId: z.string(),
  confidenceLevel: z.number(), // 90, 95, or 99
});

const abTestResultResponseSchema = z.object({
  ab_test_id: z.string(),
  ab_test_variant_id: z.string(),
  conversion_event_id: z.string(),
  confidence_level: z.number(),
  is_control: z.number(), // 0 or 1

  // Traffic metrics
  exposures: z.number(),
  unique_users: z.number(),
  new_user_exposures: z.number(),
  returning_user_exposures: z.number(),
  ...
  absolute_lift: z.number(),
  relative_lift: z.number(),
  z_statistic: z.number(),
  p_value: z.number(),
  is_statistically_significant: z.number(), // 0 or 1
  recommended_sample_size_per_variant: z.number(),
});
...
export const getAbTestResult = tinybird.buildPipe({
  pipe: "ab_test_result",
  parameters: abTestResultParamsSchema,
  data: abTestResultResponseSchema,
});
...
export const abTestResultParamsConvex = zodToConvex(abTestResultParamsSchema);
...
export type SumPrimitivesData = z.infer<typeof sumPrimitivesResponseSchema>;
export type TimeseriesData = z.infer<
  typeof timeseriesPrimitivesResponseSchema
>[];
export type AudienceBreakdownData = z.infer<
  typeof audienceBreakdownResponseSchema
>;
export type ConversionsBreakdownData = z.infer<
  typeof conversionsBreakdownResponseSchema
>;
export type RealtimeOverviewData = z.infer<
  typeof realtimeOverviewResponseSchema
>;
export type AbTestResultData = z.infer<typeof abTestResultResponseSchema>[];
