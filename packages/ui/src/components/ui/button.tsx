...
const ButtonShortcut = ({ children }: { children: React.ReactNode }) => {
  return (
    <kbd
      ...
      group-data-[variant=destructive]:border-destructive/20 group-data-[variant=destructive]:bg-destructive/10 group-data-[variant=destructive]:text-destructive/80 group-data-[variant=destructive]:hover:text-destructive-foreground
